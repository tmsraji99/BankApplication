app.controller("incentivesCtrl",function($scope,$window,$timeout,$http,$q,userlistServices,incentivesService,$rootScope){	
	...
	$scope.roleChange=function(){
		...
		$scope.searchcategory;
		  $http.get("rest/Reg").then(function(response){
	...
	$scope.viewInfo = function(canid) {
		
		$scope.isLoading= true;
		var candidateid = canid
