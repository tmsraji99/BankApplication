...
@Table(name="amrejected")
@javax.persistence.Entity
public class Amrejected implements Entity  {
	@Id
    @GeneratedValue
    private Long id;
	...
	public String getStatusNodes() {
		return statusNodes;
	}
	public void setStatusNodes(String statusNodes) {
